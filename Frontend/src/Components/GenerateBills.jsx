...
const GenerateBills = () => {
  ...
  useEffect(() => {
    const fetchBusinessDetails = async () => {
      ...
      try {
        const response = await fetch('https://invoice-gen-zqhy.onrender.com/api/auth/profile', {
  ...
  const handleSubmit = async (e) => {
    ...
    invoiceWindow.document.write(`
      <html>
        ...
        <body>
          <div class="header">
            ${billData.businessDetails.logo ? `<img src="https://invoice-gen-zqhy.onrender.com${billData.businessDetails.logo}" alt="Business Logo"/>` : ''}
    ...
    try {
      ...
      const response = await fetch('https://invoice-gen-zqhy.onrender.com/api/invoices', {
        method: 'POST',
        headers: {
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex items-center mb-8 space-x-6 bg-white p-6 rounded-lg shadow-md">
        {businessDetails.logo && (
          <img
            src={`https://invoice-gen-zqhy.onrender.com/${businessDetails.logo}`}
            alt="Business Logo"
